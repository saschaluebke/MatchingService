...
public class EngToGerICD10Evaluation {
    ...
    @Test
    public void evaluationWiki(){
        trainingPath1 = "/src/main/resources/translation/Wiki/Wikipedia.enCleaned";
        trainingPath2 = "/src/main/resources/translation/Wiki/Wikipedia.deCleaned";
        ArrayList<ArrayList<String>> output = evaluator.simpleTranslate("Wiki",files,trainingPath1,trainingPath2);
        assertEquals(true, true);
        ArrayList<ArrayList<String>> output2 = evaluator.synonymTranslate("Wiki",files,trainingPath1,trainingPath2);
        assertEquals(true, true);
        Matcher matcher = new Matcher(new WordStrategy(),new LevenshteinNormalized(),new ScoreSort());
        evaluator.setMatcher(matcher);
        ArrayList<ArrayList<String>> output3 = evaluator.synonymTranslate("Wiki_Word",files,trainingPath1,trainingPath2);
        assertEquals(209, output3.size());
    }
